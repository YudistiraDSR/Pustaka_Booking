...
?> </div>
             ...
             <div class="col-auto">
               <a href="
								<?= base_url("user") ?>">
                 <i class="fas fa-
shopping-cart fa-3x text-danger"></i>
               </a>
             </div>
           </div>
         </div>
...
auto mt-2">
    ...
    "user/data_user"
           ...
           <i class="fas fa-search mt-2 float-
right"> Tampilkan</i>
         </a>
       </div>
...
text-primary mt-2 float-right"> Tampilkan</i>
         </a>
       </div>
